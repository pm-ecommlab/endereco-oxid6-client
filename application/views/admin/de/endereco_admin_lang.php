...
$aLang = [
    ...
    "popUpHeadlineBilling" => "Rechnungsadresse prüfen",
    "popUpHeadlineShipping" => "Lieferadresse prüfen",
    "popUpSubline" => "Die angegebene Adresse scheint nicht korrekt zu sein.",
    "popUpHeadline" => "Adresse prüfen",
    "popUpSubline" => "Bitte überprüfen und bestätigen Sie Ihre Adresse.",
    "popUpHeadlineBilling" => "Rechnungsadresse prüfen",
    "popUpHeadlineShipping" => "Lieferadresse prüfen",
    "popUpHeadlineShipping" => "Lieferadresse prüfen",
    "popUpHeadlineBilling" => "Rechnungsadresse prüfen",
    "popUpHeadlineShipping" => "Lieferadresse prüfen",
    "popUpSublineBilling" => "Bitte überprüfen Sie Ihre Rechnungsadresse.",
    "popUpSublineShipping" => "Bitte überprüfen Sie Ihre Lieferadresse.",
    "confirmMyAddressCheckbox" => "Ich bestätige, dass meine Adresse korrekt und zustellbar ist.",
    "yourInput" => "Ihre Eingabe:",
    "editYourInput" => "Eingabe bearbeiten",
    "apiOK" => "Verbindung zum externen Server hergestellt. API-Key ist korrekt.",
    "apiError" => "Fehler. Prüfen Sie Ihren API-Key.",
    "CheckAddress" => "Adresse prüfen",
    "statusEmailNotCorrect" => "Die E-Mail Adresse scheint nicht korrekt.",
    "statusEmailError" => "Die E-Mail Adresse ist ungültig.",
    "mistypedEmail" => "Die eingegebene E-Mail-Adresse scheint fehlerhaft.",
    "apiOK" => "Verbindung zum externen Server hergestellt. API-Key ist korrekt.",
    "apiError" => "Fehler. Prüfen Sie Ihren API-Key.",
    "popUpHeadline" => "Adresse prüfen",
    "popUpHeadlineBilling" => "Rechnungsadresse prüfen",
    "popUpHeadlineShipping" => "Lieferadresse prüfen",
    "popUpSubline" => "Bitte überprüfen Sie Ihre Eingabe.",
    "yourInput" => "Ihre Eingabe:",
    "editYourAddress" => "Adresse bearbeiten",
    "yourInputLabel" => "Eingabe:",
    "apiOK" => "Verbindung zum externen Server hergestellt. API-Key ist korrekt.",
    "apiError" => "Fehler. Prüfen Sie Ihren API-Key.",
    "warningNotVerified" => "Diese Adresse konnte nicht überprüft werden.",
    "notFoundSubline" => "Ihre Adresse konnte nicht verifiziert werden. Bitte prüfen Sie Ihre Eingabe und ändern oder bestätigen sie.",
    "statusAddressNotFoundMainERP" => "Lieferadresse wurde nicht gefunden, bitte den Käufer kontaktieren.",
    "statusAddressNeedsCorrectionMainERP" => "Lieferadresse ist korrekturbedürftig.",
    "statusAddressNoPredictions" => "Korrekturvorschlag ist nicht vorhanden.",
    "statusAddressMultipleVariants" => "Lieferadresse ist mehrdeutig.",
    "statusAddressNeedsCorrectionBuilding" => "Hausnummer ist falsch oder fehlt.",
    "statusAddressBuildingNumberIsMissing" => "Keine Hausnummer enthalten.",
    "statusAddressBuildingNumberNotFound" => "Diese Hausnummer wurde nicht gefunden.",
    "statusPhoneInvalid" => "Die Rufnummer ist ungültig.",
    "statusPhoneFormatNeedsCorrection" => "Die Rufnummer ist falsch formatiert.",
    "hintFormatE164" => "Bitte schreiben Sie die Nummer im E.164 Format, z.B. +491767813.",
    "hintPhoneFixedLine" => "Bitte geben Sie eine Festnetznummer an.",
    "hintPhoneMobile" => "Bitte geben Sie eine Mobilfunknummer an.",
    "RegisterPlaceholderStreet" => "Straße",
    "RegisterPlaceholderStreetNumber" => "Hausnummer",
    "warningApiUnavailable" => "Der Dienst ist aktuell nicht erreichbar.",
    "statusAddressNotSupportedTypeMainERP" => "Adresse ist von einem nicht unterstützten Typ und wurde nicht geprüft.",
    "statusEmailNotCorrect" => "Die E-Mail Adresse scheint nicht korrekt.",
    "statusAddressNotFoundMainERP" => "Lieferadresse wurde nicht gefunden, bitte den Käufer kontaktieren.",
    "statusAddressNeedsCorrectionBuilding" => "Die Hausnummer ist falsch oder fehlt.",
    "statusAddressBuildingNumberNotFound" => "Diese Hausnummer wurde nicht gefunden.",
    "statusPhoneInvalid" => "Die Rufnummer ist ungültig.",
    "statusPhoneFormatNeedsCorrection" => "Die Rufnummer ist falsch formatiert.",
    "statusAddressCorrectMainERP" => "",
    "apiOK" => "Verbindung zum externen Server hergestellt. API-Key ist korrekt.",
    "apiError" => "Fehler. Prüfen Sie Ihren API-Key.",
    'ENDERECO_ORDER_TAB' => 'Endereco Address Check',
    'ENDERECO_CHECK_STATUS' => 'Check Status',
